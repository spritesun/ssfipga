...
jQuery.NiceJForms = {
    ...
    replaceRadios: function()
    {
        ...
        jQuery.NiceJForms.radios.each(function(q) {
            ...
            $(jQuery.NiceJForms.radioLabels[q]).bind('click', {who: q}, function(e) {
                self.rechangeRadios(e)
            });
    ...
    focusRadios: function(who) {
        $('#myRadio' + who).css({border: '1px dotted #333', margin: '0'});
        return false;
    },

    blurRadios:function(who) {
        $('#myRadio' + who).css({border: 'none', margin: '1px'});
        return false;
    },
    ...
    replaceCheckboxes: function ()
    {
        ...
        jQuery.NiceJForms.checkboxes.each(function(q) {
            ...
            if (!$.browser.safari)
            {
                $(jQuery.NiceJForms.checkboxLabels[q]).bind('click', {who:q}, function(e) {
            ...
            if (!$.browser.msie)
            {
                $(jQuery.NiceJForms.checkboxes[q]).bind('focus', {who:q}, function(e) {
                    self.focusCheckboxes(e)
                });
                $(jQuery.NiceJForms.checkboxes[q]).bind('blur', {who:q}, function(e) {
    ...
    replaceTexts: function() {
        jQuery.NiceJForms.texts.each(function(q) {
            $(jQuery.NiceJForms.texts[q]).css({width:(this.size || 20) * 10 + 'px'});
            ...
            //create hovers
            $(jQuery.NiceJForms.texts[q]).focus(function() {
    ...
    replaceTextareas: function() {
        jQuery.NiceJForms.textareas.each(function(q) {
            ...
            //create hovers
            $(jQuery.NiceJForms.textareas[q]).focus(function() {
